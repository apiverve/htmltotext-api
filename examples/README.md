# HTML to Text API - Examples

This folder contains example code for using the HTML to Text API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/htmltotext',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/htmltotext");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/htmltotext](https://docs.apiverve.com/ref/htmltotext)
