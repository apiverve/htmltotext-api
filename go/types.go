...
// Request contains the parameters for the HTML to Text API.
//
// Parameters:
...
// ResponseData contains the data returned by the HTML to Text API.
type ResponseData struct {
	Text string `json:"text"`
	Parsed bool `json:"parsed"`
	DetectedLanguage DetectedLanguageData `json:"detectedLanguage"`
}

// DetectedLanguageData represents the detectedLanguage object.
