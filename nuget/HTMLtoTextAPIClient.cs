...
namespace APIVerve.API.HTMLtoText
{
    ...
    /// <summary>
    /// Client for the HTMLtoText API
    /// </summary>
    public class HTMLtoTextAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/htmltotext";
        ...
        {
            { "html", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public HTMLtoTextAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HTMLtoTextAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public HTMLtoTextAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, HTMLtoTextQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(HTMLtoTextQueryOptions options)
        {
        ...
        public ResponseObj Execute(HTMLtoTextQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(HTMLtoTextQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(HTMLtoTextQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(HTMLtoTextQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(HTMLtoTextQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(HTMLtoTextQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(HTMLtoTextQueryOptions options)
        {
