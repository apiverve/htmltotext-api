...
/**
 * Client for the HTML to Text API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://htmltotext.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/htmltotext';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\HtmltotextClient] {$message}\n";
        }
    }
}
